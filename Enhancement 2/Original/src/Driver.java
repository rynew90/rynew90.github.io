 ...
 * File: Driver.java
 * Version: 1.0
 * Description: This file holds the main function to display the menu and take user input. It also holds the functions for each of the menu options and a
 * 				merge sort algorithm to sort the list of animals.
 */
